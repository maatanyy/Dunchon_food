...
public class MyungActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myung);

        RecyclerView recyclerView = findViewById(R.id.recyclerView);

        LinearLayoutManager layoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL,false);
        recyclerView.setLayoutManager(layoutManager);
        RecfoodAdapter3 adapter = new RecfoodAdapter3();

        adapter.addItem(new Recfood(R.drawable.myunga1,"명가해장국","7,000원"));
        adapter.addItem(new Recfood(R.drawable.myunga2,"낚지덮밥","7,000원"));
        adapter.addItem(new Recfood(R.drawable.myunga3,"제육덮밥","6,000원"));
