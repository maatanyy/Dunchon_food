...
public class RecfoodAdapter3 extends  RecyclerView.Adapter<RecfoodAdapter3.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.recfood_item3,viewGroup,false);
