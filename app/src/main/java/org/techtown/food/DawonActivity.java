...
public class DawonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dawon);
        ...
        RecfoodAdapter2 adapter = new RecfoodAdapter2();

        adapter.addItem(new Recfood(R.drawable.dawon1,"대원왕족발소","27,000원"));
        adapter.addItem(new Recfood(R.drawable.dawon2,"대원보쌈소","27,000원"));
        adapter.addItem(new Recfood(R.drawable.dawon3,"굴보쌈중","37,000원"));
