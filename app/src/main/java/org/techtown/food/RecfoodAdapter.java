...
public class RecfoodAdapter extends  RecyclerView.Adapter<RecfoodAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.recfood_item,viewGroup,false);
